...
public class Activity_Foods_Poha extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__foods__poha);
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String info = "https://www.indianhealthyrecipes.com/poha-recipe-kanda-batata-poha/";
        ...
        i3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri gmmIntentUri = Uri.parse("https://www.google.com/maps/search/poha+near+me/@18.5933416,73.8979599,13z/data=!3m1!4b1");
